...
В страке "const limit = 20;" указываем кличество сколько постов надо удалить <br>
Запускается скрипт в консоле браузера на странице https://dzen.ru/profile/editor/ВАШ_ЛОГИН/publications <br>
